...
const icon: Record<IconKey, ReactNode> = {
  ...
  dollar: (<svg viewBox="0 0 24 24" className="h-5 w-5 fill-none stroke-current" strokeWidth="1.6" aria-hidden><path d="M12 2v20" strokeLinecap="round" /><path d="M16.5 6.5A3.5 3.5 0 0 0 13 5h-1.5a3 3 0 0 0 0 6h1a3 3 0 0 1 0 6H11a3.5 3.5 0 0 1-3.5-1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>),
