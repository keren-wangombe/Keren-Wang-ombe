    ...
    <section className="relative isolate overflow-hidden bg-paper">
      ...
      <div className="container-content py-8 sm:py-9">
        <Reveal>
          ...
          <h2 className="mt-2 max-w-2xl font-serif text-[clamp(1.35rem,2.6vw,1.9rem)] font-light leading-snug text-ink">
        ...
        <Reveal className="mt-6">
          {linkedinEmbedUrl ? (
            ...
            <div className="mx-auto flex max-w-xl flex-col items-center gap-5 rounded-2xl border border-ink/10 bg-paper p-6 text-center shadow-lg shadow-ink/5 sm:flex-row sm:text-left">
              <span className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-signature text-paper">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="link-amber mt-3 inline-flex items-center gap-2 text-small font-medium text-signature"
                >
