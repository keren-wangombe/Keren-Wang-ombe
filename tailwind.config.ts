  ...
  theme: {
    extend: {
      colors: {
        ...
        background: "#FAFAF8",
        foreground: "#111827",
        primary: { DEFAULT: "#1B3A6B", foreground: "#FAFAF8" },
        link: "#3D6491",
        accent: { DEFAULT: "#B45309", foreground: "#FAFAF8" },
      },
      fontFamily: {
      ...
      transitionDuration: { reveal: "700ms" },
      keyframes: {
        "fade-up": { from: { opacity: "0", transform: "translateY(16px)" }, to: { opacity: "1", transform: "translateY(0)" } },
        "fade-in": { from: { opacity: "0" }, to: { opacity: "1" } },
        "hero-rise": { from: { opacity: "0", transform: "translateY(28px)" }, to: { opacity: "1", transform: "translateY(0)" } },
      },
      animation: {
